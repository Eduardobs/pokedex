...
const apiTermTranslations: Record<Language, Record<string, string>> = {
  'pt-BR': {
    ...
    wings: 'Com asas',
    tentacles: 'Com tentáculos',
    heads: 'Múltiplas cabeças',
    'bug-wings': 'Inseto alado',
    armor: 'Com armadura',
    walk: 'Caminhando',
    surf: 'Surfe',
    'old-rod': 'Vara velha',
    ...
    wanderer: 'Errante',
    sos: 'Chamado por ajuda',
    'npc-trade': 'Troca com NPC',
    'max-raid': 'Batalha Max Raid',
    'rock-smash': 'Quebra-rocha',
    headbutt: 'Cabeçada',
    'dark-grass': 'Grama escura',
    'time-morning': 'De manhã',
    'time-day': 'Durante o dia',
    'time-night': 'À noite',
    'weather-normal': 'Clima normal',
    'weather-overcast': 'Tempo nublado',
    'weather-raining': 'Chuva',
    'weather-intense-sun': 'Sol intenso',
    'weather-sandstorm': 'Tempestade de areia',
    'weather-thunderstorm': 'Tempestade',
    'weather-fog': 'Neblina',
    'story-progress-before-hall-of-fame': 'Antes do Hall da Fama',
    'story-progress-hall-of-fame': 'Após o Hall da Fama',
    'max-den-rarity-common': 'Covil comum',
    'max-den-rarity-rare': 'Covil raro',
    'max-den-rarity-special': 'Covil especial',
  },
  en: {
    walk: 'Walking',
    surf: 'Surfing',
    ...
    'weather-fog': 'Fog',
    'story-progress-before-hall-of-fame': 'Before the Hall of Fame',
    'story-progress-hall-of-fame': 'After the Hall of Fame',
  ...
  es: {
    ...
    'weather-fog': 'Niebla',
    'story-progress-before-hall-of-fame': 'Antes del Salón de la Fama',
    'story-progress-hall-of-fame': 'Después del Salón de la Fama',
    'max-den-rarity-common': 'Nido común',
    'max-den-rarity-rare': 'Nido raro',
    'max-den-rarity-special': 'Nido especial',
  },
}
