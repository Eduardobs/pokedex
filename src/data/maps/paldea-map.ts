...
export const PALDEA_CATEGORY_GROUPS: GameMapCategoryGroup[] = [
  {
    ...
    categories: [
      ...
      category('food-store', 'maps.category.foodStore', 'maps.marker.paldeaLocationSummary', 78, '#3f7791', 'food'),
      category(
        'hairdresser',
      ...
      category('location', 'maps.category.location', 'maps.marker.paldeaLocationSummary', 15, '#3f7791', 'area'),
      category(
        'pokemon-center',
      ...
      category('shrine', 'maps.category.shrine', 'maps.marker.paldeaLocationSummary', 4, '#3f7791', 'shrine'),
      category(
        'watchtower',
  ...
  },
  {
    ...
    categories: [
      ...
      category('tm', 'maps.category.tm', 'maps.marker.paldeaCollectibleSummary', 566, '#89418f', 'tm'),
    ],
  },
  {
    id: 'items',
    ...
    categories: [
      category('battle-item', 'maps.category.battleItem', 'maps.marker.paldeaItemSummary', 189, '#287f7e', 'battle'),
      category('herba-mystica', 'maps.category.herbaMystica', 'maps.marker.paldeaItemSummary', 5, '#287f7e', 'berry'),
      category('medicine', 'maps.category.medicine', 'maps.marker.paldeaItemSummary', 1103, '#287f7e', 'medicine'),
      category('other-item', 'maps.category.otherItem', 'maps.marker.paldeaItemSummary', 525, '#287f7e', 'item'),
      category('poke-ball', 'maps.category.pokeBall', 'maps.marker.paldeaItemSummary', 390, '#287f7e', 'poke-ball'),
      category('treasure', 'maps.category.treasure', 'maps.marker.paldeaItemSummary', 136, '#287f7e', 'key-item'),
    ],
  },
  {
    id: 'missions',
  ...
  },
  {
    ...
    categories: [
      category('gym-leader', 'maps.category.gymLeader', 'maps.marker.paldeaBattleSummary', 8, '#827168', 'battle'),
      category(
        'team-star-boss',
      ...
      category('trainer', 'maps.category.trainer', 'maps.marker.paldeaBattleSummary', 286, '#827168', 'trainer'),
    ],
  },
  {
    id: 'other',
    ...
    categories: [
      category('cave-entrance', 'maps.category.caveEntrance', 'maps.marker.paldeaOtherSummary', 40, '#4c4e4f', 'cave'),
      category('miscellaneous', 'maps.category.miscellaneous', 'maps.marker.paldeaOtherSummary', 3, '#4c4e4f', 'area'),
