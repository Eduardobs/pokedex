...
export const KITAKAMI_CATEGORY_GROUPS: GameMapCategoryGroup[] = [
  ...
  },
  {
    ...
    categories: [category('tm', 'maps.category.tm', 'maps.marker.kitakamiCollectibleSummary', 160, '#89418f', 'tm')],
  },
  {
    id: 'items',
    labelKey: 'maps.group.items',
    categories: [
      category('battle-item', 'maps.category.battleItem', 'maps.marker.kitakamiItemSummary', 29, '#287f7e', 'battle'),
      category('key-item', 'maps.category.keyItem', 'maps.marker.kitakamiItemSummary', 1, '#287f7e', 'key-item'),
      category('medicine', 'maps.category.medicine', 'maps.marker.kitakamiItemSummary', 280, '#287f7e', 'medicine'),
      category('other-item', 'maps.category.otherItem', 'maps.marker.kitakamiItemSummary', 95, '#287f7e', 'item'),
      category('poke-ball', 'maps.category.pokeBall', 'maps.marker.kitakamiItemSummary', 79, '#287f7e', 'poke-ball'),
      category('treasure', 'maps.category.treasure', 'maps.marker.kitakamiItemSummary', 16, '#287f7e', 'key-item'),
    ],
  },
  {
    id: 'battles',
    ...
    categories: [
      category('trainer', 'maps.category.trainer', 'maps.marker.kitakamiBattleSummary', 47, '#827168', 'trainer'),
    ],
  },
  {
    id: 'other',
