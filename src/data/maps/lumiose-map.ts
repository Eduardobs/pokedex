...
export const LUMIOSE_CATEGORY_GROUPS: GameMapCategoryGroup[] = [
  {
    ...
    categories: [
      ...
      category('wild-zone', 'maps.category.wildZone', 'maps.marker.lumioseLocationSummary', 20, '#3f7791', 'area'),
    ],
  },
  {
    id: 'services',
    ...
    categories: [
      category('boutique', 'maps.category.boutique', 'maps.marker.lumioseServiceSummary', 41, '#418f71', 'clothing'),
      category('cafe', 'maps.category.cafe', 'maps.marker.lumioseServiceSummary', 17, '#418f71', 'food'),
      category(
        'hair-salon',
      ...
      category('restaurant', 'maps.category.restaurant', 'maps.marker.lumioseServiceSummary', 4, '#418f71', 'food'),
    ],
  },
  {
    id: 'collectibles',
    ...
    categories: [
      ...
      category('tm', 'maps.category.tm', 'maps.marker.lumioseCollectibleSummary', 107, '#89418f', 'tm'),
    ],
  },
  {
    id: 'items',
    ...
    categories: [
      category('key-item', 'maps.category.keyItem', 'maps.marker.lumioseItemSummary', 15, '#46a3a2', 'key-item'),
      category('medicine', 'maps.category.medicine', 'maps.marker.lumioseItemSummary', 394, '#46a3a2', 'medicine'),
      category('other-item', 'maps.category.otherItem', 'maps.marker.lumioseItemSummary', 316, '#46a3a2', 'item'),
      category('poke-ball', 'maps.category.pokeBall', 'maps.marker.lumioseItemSummary', 314, '#46a3a2', 'poke-ball'),
      category('treasure', 'maps.category.treasure', 'maps.marker.lumioseItemSummary', 65, '#46a3a2', 'key-item'),
    ],
  },
  {
    id: 'missions',
  ...
  },
  {
    ...
    categories: [
      category('ladder', 'maps.category.ladder', 'maps.marker.lumioseOtherSummary', 160, '#4c4e4f', 'transition'),
      category(
        'miscellaneous',
