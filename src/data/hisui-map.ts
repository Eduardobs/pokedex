...
export const HISUI_CATEGORY_GROUPS: GameMapCategoryGroup[] = [
  ...
  },
  {
    ...
    categories: [
      category(
        'character',
        'maps.category.character',
        'maps.marker.hisuiOtherSummary',
        43,
        '#4c4e4f',
        'npc',
      ),
