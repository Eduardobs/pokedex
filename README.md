...
- **Detailed Pokémon pages** with species information, abilities, forms, shiny sprites, cries, held items, game indices, base stats, defensive type matchups, evolution chains, compatible moves, and encounter areas.
